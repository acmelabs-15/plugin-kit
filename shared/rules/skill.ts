 ...
 *
 * The structural half is `../scripts/validate-skill.ts` unchanged -- it is
 ...
 * purity pass calls `../scripts/check-bun-purity.ts`, whose superset pre-filter
...
import { checkDirectory } from "../scripts/check-bun-purity.ts";
import { validateSkill } from "../scripts/validate-skill.ts";
import { collisionSection } from "./collisions.ts";
import { isDirectory, pathExists, resolvePath } from "./lib.ts";
