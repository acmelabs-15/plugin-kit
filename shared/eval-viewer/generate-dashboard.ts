...
function resolveKnownScript(scriptName: string): string | null {
  const known: Record<string, string> = {
    "optimize-description.ts": "../scripts/optimize-description.ts",
    "measure-triggering.ts": "../scripts/measure-triggering.ts",
    "aggregate-results.ts": "../scripts/aggregate-results.ts",
