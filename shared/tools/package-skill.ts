 ...
 *
 * Usage:
 *     bun shared/tools/package-skill.ts <path/to/skill-folder> [output-directory]
 *                                  [--standard|--extended]
 *
 * Example:
 *     bun shared/tools/package-skill.ts skills/public/my-skill
 *     bun shared/tools/package-skill.ts skills/public/my-skill ./dist
 *     bun shared/tools/package-skill.ts skills/my-skill --extended
 *
...
import {
  ...
  validateSkill,
  type Tier,
} from "../validate/validate-skill.ts";
...
const USAGE =
  "Usage: bun shared/tools/package-skill.ts <path/to/skill-folder> [output-directory] [--standard|--extended]";
