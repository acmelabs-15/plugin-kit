 ...
 *
 * USAGE
 *   bun shared/operations/synthesize-scenarios.ts --target <path> --out <path>
 *   bun shared/operations/synthesize-scenarios.ts --target <path> --inventory-only
 *
 * EXIT
...
const USAGE = [
  "Usage: bun shared/operations/synthesize-scenarios.ts --target <path> --out <path> [options]",
  "",
