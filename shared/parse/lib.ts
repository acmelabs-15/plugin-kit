 ...
 *
 * Real YAML here, deliberately. `./frontmatter.ts` is a
 ...
 * to see what the loader sees. `../validate/validate-skill.ts` and
 * `../tools/check-overlap.ts` both make the same choice for the same reason.
 */
