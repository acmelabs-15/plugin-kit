 ...
 *
 * Usage: bun shared/scripts/validate-skill.ts <skill-dir> [--standard|--extended]
...
import { skillMdPath } from "./lib/frontmatter.ts";
...
const USAGE = "Usage: bun shared/scripts/validate-skill.ts <skill-dir> [--standard|--extended]";
